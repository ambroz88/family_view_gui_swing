...
import org.ambrogenea.familyview.service.impl.parsing.A4WordGeneratorService;
...
public class ApplicationWindow extends JFrame implements PropertyChangeListener {
    ...
    private void initComponents() {
        ...
        imageHeightSlider.setMaximum(200);
        imageHeightSlider.setMinimum(80);
        ...
        parentPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, parentPanelLayout.createSequentialGroup()
                ...
                .addGroup(parentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(imageHeightSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(personImagePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        siblingsHeightSlider.setMaximum(200);
        siblingsHeightSlider.setMinimum(80);
        ...
        siblingPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, siblingPanelLayout.createSequentialGroup()
                ...
                .addGroup(siblingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(siblingsHeightSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(siblingsImagePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
            ...
            .addGroup(settingsRootPanelLayout.createSequentialGroup()
                ...
                .addGroup(settingsRootPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(settingsRootPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(siblingPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                        .addComponent(parentPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)))
                .addGap(14, 14, 14)
                .addGroup(settingsRootPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(settingsRootPanelLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(settingsTab, javax.swing.GroupLayout.DEFAULT_SIZE, 1494, Short.MAX_VALUE))
        );
    ...
    private void generateTreeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateTreeButtonActionPerformed
        if (recordsTable.getSelectedRow() != -1) {
            ...
            String personId = familyData.getPersonByPosition(recordsTable.getSelectedRow()).getId();
            ...
            settingsTab.addTab(treeModel.getTreeName(), drawing);
    ...
    private void generateWordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateWordActionPerformed
        if (recordsTable.getSelectedRow() != -1) {
            ...
            DocumentGeneratorService service = new A4WordGeneratorService(configuration);
            java.util.List<DocumentInputs> inputs = service.generateFamilies(personId, familyData);
            inputs.forEach(input -> {
                input.setImageStream(createOneFamily(input.getTreeModel()).getStream());
            });

            XWPFDocument doc = service.generateDocument(inputs);
            String personName = Tools.getNameIn2ndFall(inputs.get(0).getTreeModel().getRootPerson());
            saveFamilyDocument("Rodiny " + personName, doc);
        }
    ...
    private TreePanel createOneFamily(TreeModel treeModel) {
    ...
    private void saveFamilyDocument(String doucmentName, XWPFDocument doc) {
        try {
            WordGenerator.writeDocument(System.getProperty("user.home") + "/Documents/Genealogie/" + doucmentName + ".docx", doc);
